...
python3 "$SCRIPT_DIR/prepare-smoke-fixtures.py" "$MANIFEST" "$SMOKE_WORKSPACE/inputs"
MANIFEST="$SMOKE_WORKSPACE/inputs/manifest.json"
FAKE_CLI="$SMOKE_WORKSPACE/inputs/fake-whisper-cli.sh"
FAKE_MODEL="$SMOKE_WORKSPACE/inputs/fake-model.bin"
