...
public struct LiveContextHostedReceipt: Sendable, Codable, Equatable {
    ...
    public init(schemaVersion: String = currentSchemaVersion, generatedAt: String, gitSHA: String, treeIsDirty: Bool, sourceManifestSHA256: String, failureCount: Int, skipCount: Int, failures: [LiveContextFailureRow], skips: [LiveContextFailureRow], scope: Scope = .init(), thresholds: Thresholds = .init(), wrapperAttestation: WrapperAttestation? = nil, environment: Environment, environmentIdentitySHA256: String, syntheticCoordinatorListeningAcknowledgementDefinition: String = "production-dictation-controller-entry-through-injected-immediate-coordinator-capture-acknowledgement-to-nonactivating-panel-order-return-diagnostic-only", syntheticCoordinatorListeningAcknowledgementDiagnostic: LiveLatencyDistribution, overlayMainActorDefinition: String = "production-overlay-mainactor-render-start-to-render-complete", overlayMainActorWork: LiveLatencyDistribution, renderedUpdateTimestampsMS: [Double], syntheticCoordinatorStopToInsertionDefinition: String = "production-session-coordinator-capture-stop-call-to-injected-synthetic-engine-insertion-complete-diagnostic-only", syntheticCoordinatorStopToInsertionEnabledDiagnostic: LiveLatencyDistribution, syntheticCoordinatorStopToInsertionDisabledControlDiagnostic: LiveLatencyDistribution, acceptedPreviewCount: Int, renderedPreviewCount: Int, maximumQueueDepth: Int, coalescedPreviewCount: Int, trialOrder: [LiveContextTrialMode], configurationIdentitySHA256: String, lifecycle: Lifecycle, noSpeechDisplayDefinition: String = "production-session-coordinator-live-snapshot-through-production-overlay-preview-rendered-observer", correctness: Correctness, privacy: Privacy, staticAudit: StaticAudit) {
        self.schemaVersion = schemaVersion
        self.generatedAt = generatedAt
        self.gitSHA = gitSHA
        self.treeIsDirty = treeIsDirty
